...
# Optional label maps
label_maps = {
    "SMS Spam": {0: "Not Spam", 1: "Spam"},
    "Fake News": {0: "Real", 1: "Fake"},
    "Amazon Sentiment": {0: "Neutral", 1: "Negative", 2: "Positive"},
    "News Category": {
...
# UI
st.set_page_config(page_title="NeuroEngine", layout="centered")  # Optional
st.title("🧠 NeuroEngine: AI NLP Analyzer")
